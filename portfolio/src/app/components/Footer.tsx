...
const Foot: React.FC = () => {
  return (
    /*Simple Footer EJS file, has linkedin link and my name, may add other socials later*/
    <>
      <div className="mb-4"></div>
      <footer id="main-footer" className="footer py-3 mt-auto">
        <div className="container text-muted mx-0 mt-2">
          <div className="row">
            <div className="col-1 d-flex justify-sm-content-start">
              ...
              <a
                href="https://github.com/vaeleborne"
                rel="noopener noreferrer"
                target="_blank"
